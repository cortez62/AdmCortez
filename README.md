# phreaker56-Script V5.0

# WE KEEP UPDATING THIS SCRIPT...
...
wget -q -O instala.sh https://www.dropbox.com/s/53wxrth00x3a7ao/instala.sh; chmod +x instala.sh;./instala.sh
