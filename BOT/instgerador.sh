...
function_verify () {
  permited=$(curl -sSL "https://raw.githubusercontent.com/phreaker56/phreaker56/master/BOT/VPSBOT/main/TeleBotGen/Control/Control-Bot")
  [[ $(echo $permited|grep "${IP}") = "" ]] && {
  echo -e "\n\n\n\033[1;31m====================================================="
  echo -e "\033[1;31m       ¡LA IP $(wget -qO- ipv4.icanhazip.com) NO ESTA AUTORIZADA!"
  echo -e "\033[1;31m                CONTACTE A @phreakr56"
  echo -e "\033[1;31m=====================================================\n\n\n"
  [[ -d /etc/SCRIPT ]] && rm -rf /etc/SCRIPT
  exit 1
  } || {
  ### INTALAR VERCION DE SCRIPT
  v1=$(curl -sSL "https://www.dropbox.com/s/unx30xzokto338o/v-new.log")
...
wget https://raw.githubusercontent.com/phreaker56/phreaker56/master/BOT/gerador/gerar.sh &>/dev/null
