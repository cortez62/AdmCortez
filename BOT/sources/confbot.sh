...
msg -bar
echo -e "\033[1;37m   Es necesario crear un bot en \033[1;32m@Phreakr56 "
msg -bar
echo -e "\033[1;32m1- \033[1;37mEn su apps telegram ingrese a @Phreakr56"
echo -e "\033[1;32m2- \033[1;37mDigite el comando \033[1;31m/newbot"
echo -e "\033[1;32m3- @Phreakr56 \033[1;37msolicitara que\n   asigne un nombre a su bot"
echo -e "\033[1;32m4- @Phreakr56 \033[1;37msolicitara que asigne otro nombre,\n   esta vez deve finalizar en bot eje: \033[1;31mXXX_bot"
echo -e "\033[1;32m5- \033[1;37mObtener token del bot creado.\n   En \033[1;32m@Phreakr56 \033[1;37mdigite el comando \033[1;31m/token\n   \033[1;37mseleccione el bot y copie el token."
...
wget -O $HOME/update.sh https://raw.githubusercontent.com/phreaker56/phreaker56/master/BOT/update.sh &> /dev/null
