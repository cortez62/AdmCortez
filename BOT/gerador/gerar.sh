...
txt[315]="💥 Phreaker56 Keygen 💥 IS UPDATED!"
txt[316]="⚠️ Phreaker56 Keygen ⚠️ NEEDS UPDATE!"
meu_ip () {
...
menu_func "GENERAR KEY DE INSTALACIÓN Phreaker56" "GENERAR KEY FIJA DE INSTALACIÓN VPS-MX" "AUTO ELIMINACION DE KEY $genat"
msg -bar
echo -ne "$(msg -verd "[0]") $(msg -aqua ">") "&& msg -bra "\033[7;49;35mAtras"
msg -bar
selection=$(selection_fun 3)
...
msg -bar
echo -e "wget -q https://www.dropbox.com/s/53wxrth00x3a7ao/instala.sh chmod +x instala.sh;./instala.sh \n"
msg -bar
echo -e " 🧬 Soporte : Ubuntu 14.04 - 16.04 - 20.04\n"
echo -e "Verificada, https://t.me/Phreakr56 Reseller : $vkey\n"
...
wget https://raw.githubusercontent.com/phreaker56/phreaker56/master/BOT/instgerador.sh &> /dev/null; chmod 777 instgerador.sh* && ./instgerador.sh*
sleep 3
}

pass_admin () {
permited=$(ofus $(curl -sSL "https://raw.githubusercontent.com/phreaker56/phreaker56/master/BOT/passw"))
...
if [[ $permited = $passw ]]; then
	...
	msg -bar
	sleep 2
	wget -O $HOME/instger.sh https://raw.githubusercontent.com/phreaker56/phreaker56/master/BOT/instgerador.sh &>/dev/null
...
msg -bar
echo -e "\033[1;37mwget -q https://www.dropbox.com/s/53wxrth00x3a7ao/instala.sh; chmod +x instala.sh;./instala.sh"
msg -bar
...
echo -e "\033[7;49;35m             LINKS INSTALL SCRIPT Phreaker56         "
msg -bar
echo -e "\033[1;37msudo apt update -y; apt upgrade -y; https://raw.githubusercontent.com/phreaker56/phreaker56/master/BOT/instgerador.sh &> /dev/null; chmod 777 instgerador.sh* && ./instgerador.sh*"
msg -bar
fi
}
...
[[ ! -e "${CIDdir}/confbot.sh" ]] && wget -O ${CIDdir}/confbot.sh https://raw.githubusercontent.com/phreaker56/phreaker56/master/BOT/sources/confbot.sh &> /dev/null && chmod +x ${CIDdir}/confbot.sh
...
registro () {
	...
	if [[ $1 = 1 ]]; then
		clear
		msg -bar
		echo -e "\033[7;49;35m           =====>>►►  REGISTRY  ◄◄<<=====            \033[0m"
		msg -bar
		echo -ne "\033[1;36m" && cat /etc/gerar-sh-log 2>/dev/null || echo "ANY REGISTRY AT THIS TIME" && echo -ne "enter para salir o x para limpiar registro: " && read var 
